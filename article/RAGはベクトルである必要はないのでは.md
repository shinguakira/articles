...
キーワード検索とベクトル検索を組み合わせた**ハイブリッド検索**という手法もありますが、実際にはキーワード一致側が大部分を担っていて、ベクトルが貢献している割合は思ったより小さいのではと感じています。

**Knowledge Graph**のように関係性を構造として持つアプローチは、エンティティ間のつながりを辿りたいケースで有効だと思いますが、ベクトルである必要は必ずしもないのではと思っています。
もしあいまいが必要だったとしても、今は**クエリリライト**で別途あいまいさなどや関連を担保して、DB側にあいまいさを持たせる必要性が下がっている気がします。
